...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', default='train_few_shot')
    ...
    parser.add_argument('--train_images', type=str, default="/path/to/train/images/", help= 'path/to/train/images')
    parser.add_argument('--train_labels', type=str, default="/path/to/train/labels/", help= 'path/to/train/labels')
    parser.add_argument('--val_images', type=str, default="/path/to/valid/images", help= 'path/to/valid/images')
    parser.add_argument('--val_labels', type=str, default="/path/to/valid/labels", help= 'path/to/valid/labels')
